...
import { BookUser, Mail, Phone, User } from 'lucide-react-native';
...
const RecipientNameField = ({ control, method, recipientsList, onSelectedRecipient, openAddressBook }) => {
        ...
        <View style={{ position: 'relative' }}>
            <Controller
                ...
                render={({ field: { onChange, value }, fieldState: { error } }) => {
                    ...
                    return (
                        <View>
                            <AppInput label="Name" placeholder="Enter your name" value={value} onChangeText={(text) => {
                                onChange(text);
                            ...
                            }} error={error?.message} leftIcon={User} onRightIconPress={openAddressBook} rightIcon={BookUser} />
