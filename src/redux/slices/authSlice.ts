...
export const loadUser = createAsyncThunk("auth/loadUser", async () => {
  ...
  if (user && token) {
    return { user: JSON.parse(user), token , subscription: JSON.parse(subscription)};
  }
...
export const { logout,updateUser ,updateToken,setUser,setSubscription,updateSubscriptionLocally} = authSlice.actions;
