      ...
      <View style={{ flex: 1 }}>
        ...
        <KeyboardAwareScrollView
          ...
          <View style={styles.inner}>
            ...
            <TouchableOpacity onPress={() => goBack()} style={{ marginTop: hp(4), }}>
              <Text style={{ textAlign: 'center', fontFamily: Fonts.Regular }}>Already have an account? <Text style={{ color: Colors.primary, fontFamily: Fonts.Medium }}>Sign In</Text></Text>
