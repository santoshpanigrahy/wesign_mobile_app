      ...
      <View style={{ flex: 1 }}>
        <View style={{ paddingVertical: hp(2) }}>
          <View style={styles.uploadBox}>
            ...
            {image ? (
              ...
              <TouchableOpacity
                ...
                <Text style={styles.uploadText}>Upload Stamp</Text>
              </TouchableOpacity>
            )}
          </View>
          ...
          <Text
            ...
            By clicking Save, I agree that the image above will be the
            electronic representation of my stamp for all purposes when I (or my
            agent) use them on documents, including legally binding contracts –
            just the same as a stamp-and-paper.
          </Text>
        </View>
      </View>
